...
formulaInput.addEventListener("blur" , function(e){
    ...
    if(formula){
        ...
        //solve formula mai cellobject voh vala bhejenge jo update hona chahta hai jo last selected cell hai voh vala
        // EDGE CASE VALUE TO VALUE UPDATE VALA :- jaha par ek value doosri value par dependent ho jese A1 ki value change karenge toh B1(30) uski value bhi change hogi
        //ye kaam A1 ke chiildren ke liye hoga  
