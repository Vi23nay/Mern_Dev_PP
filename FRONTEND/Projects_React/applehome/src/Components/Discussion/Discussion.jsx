...
const Discussion = (props) => {
  ...
  return (
    <div className={classes.colorofbackground}>
      ...
      <div className="feeds-video-list" style={{ margin: "auto",backgroundImage:`url(${p1})`,backgroundSize:"contain"}}>
          {posts.map((postObj) => {
        ...
        :
        (
          <div className="feeds-video-list" style={{ margin: "auto",backgroundImage:`url(${discussionimg})`,backgroundSize:"contain"}}>
          {posts.map((postObj) => {
            return <VideoPost key={postObj.pid} postObj={postObj}></VideoPost>;
          })}
        </div>
